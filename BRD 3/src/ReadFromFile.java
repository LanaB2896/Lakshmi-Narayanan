...
//					System.out.println(DataBaseConnection[j]);
				...
				if(validator(DataBaseConnection)==true)
				{
					...
					database.getConnection(Integer.toString(count +=1),DataBaseConnection[0],DataBaseConnection[1],DataBaseConnection[2],
							DataBaseConnection[3],DataBaseConnection[4],DataBaseConnection[5],DataBaseConnection[6],DataBaseConnection[7],
							DataBaseConnection[8],DataBaseConnection[9],DataBaseConnection[10],DataBaseConnection[11],DataBaseConnection[12],
	...
	public static boolean validator(String[] DataBaseConnection)
	{
		...
		if(customernameRESULT  &&  pincodeRESULT  &&  emailValidationRESULT  &&  
				recordStatusValidatorRESULT  &&  Active_Inactive_FlagRESULT)
		{
			return true;
		}
		return false;
